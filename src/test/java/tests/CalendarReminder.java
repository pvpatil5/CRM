...
public class CalendarReminder 
{
	...
	public static void createReminder() throws MalformedURLException, InterruptedException 
	{
		...
		wait.until(ExpectedConditions.elementToBeClickable(OpeningPage.rightArrow(driver)));

		for(int i=0; i<2; i++)
		{
			OpeningPage.rightArrow(driver).click();
		}

		OpeningPage.doneButton(driver).click();
